...
# with gr.Blocks(theme=Base(), title="Q&A IMD") as demo:
#     gr.Markdown(
#         """
...
#     with gr.Column():
#         output1 = gr.Textbox(lines=1, max_lines=100, label="Input with just Atlas Vector Search")
#         output2 = gr.Textbox(lines=1, max_lines=100, label="Output generated by chaining Atlas Vector Search")
